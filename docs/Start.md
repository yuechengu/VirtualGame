...
* [Vue.js 2.x Guide](https://cn.vuejs.org/v2/guide/)
* [Vue.js 2.x API](https://cn.vuejs.org/v2/api/)
* [Vue Router docs](https://github.com/vuejs/vue-router/tree/1.0/docs/zh-cn)
...
> **建议**升级到 `node ≥ 6.x / npm ≥ 3.x` 环境  
> **推荐**往后使用 `cnpm` 替代 `npm` 安装依赖  
> 
